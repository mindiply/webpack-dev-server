	...
	var features = {
		...
		contentBaseFiles: function() {
			if(Array.isArray(contentBase)) {
				...
				console.log(options.staticOptions);
...
Server.prototype.listen = function() {
	...
	var sockJsPath = this.publicPath ? this.publicPath
		+ (this.publicPath.length && this.publicPath[this.publicPath.length-1] === '/' ? '' : '/') + "sockjs-node" : "/sockjs-node";
